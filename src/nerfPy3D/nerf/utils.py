...
def sample_pdf(
    ...
    Args:
        bins: Tensor of shape `(..., n_bins)` denoting the edges of the sampling bins.
    ...
    Refs:
        [1] https://github.com/bmild/nerf/blob/55d8b00244d7b5178f4d003526ab6667683c9da9/run_nerf_helpers.py#L183
    """
